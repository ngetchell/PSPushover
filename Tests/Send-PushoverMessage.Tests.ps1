    ...
    Describe 'Send-PushoverMessage' {
        ...
        Context 'Mocking Functions' { 
            It 'Mocking Invoke-RestMethod' { 
                ...
                $Results = Send-PushoverMessage -title 'Example Title' -Message 'Blank Message' -device 'ExampleDevice' -User 'Junk' -Token 'Junk'
        ...
        Context 'Checking PassThru Parameter' { 
            ...
            $Results = Send-PushoverMessage -title 'Example Title' -Message 'Blank Message' -device 'ExampleDevice' -PassThru -User 'Junk' -Token 'Junk'
